 ...
 */
export type CellRendererOverrides = Partial<Record<ColumnDataType, (props: CellRendererProps, rendererParams: GetRendererParams)
    => React.ReactElement | null | undefined>>;

/**
 * Provide cell editor overrides per column data type.
 */
export type CellEditorOverrides = Partial<Record<ColumnDataType, (defaultProps: CellEditorProps, rendererParams: GetEditorParams)
    => React.ReactElement | null | undefined>>;
